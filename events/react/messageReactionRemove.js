module.exports = (client, messageReaction, user) => {
  ...
  switch (emoji) {
    case "emoji_1":
      ...
      client.channels.cache.get('795410332742189097').send(`Le rôle ${rlRole.name} a été supprimé avec succès à ${user}!`);
      break;

      case "emoji_2":
      member.roles.add(r6sRole);
      client.channels.cache.get('795410332742189097').send(`Le rôle ${r6sRole.name} a été supprimé avec succès à ${user}!`);
      break;

      case "emoji_3":
      member.roles.add(valorantRole);
      client.channels.cache.get('795410332742189097').send(`Le rôle ${valorantRole.name} a été supprimé avec succès à ${user}!`);
      break;

      case "emoji_4":
      member.roles.add(csgoRole);
      client.channels.cache.get('795410332742189097').send(`Le rôle ${csgoRole.name} a été supprimé avec succès à ${user}!`);
      break;

      case "emoji_5":
      member.roles.add(amongusRole);
      client.channels.cache.get('795410332742189097').send(`Le rôle ${amongusRole.name} a été supprimé avec succès à ${user}!`);
      break;
